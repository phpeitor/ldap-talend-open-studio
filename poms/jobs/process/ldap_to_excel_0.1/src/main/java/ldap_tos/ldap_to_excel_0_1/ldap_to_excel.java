...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tLDAPInput_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				status = "failure";
				
					tLDAPInput_2_onSubJobError(exception, errorComponent, globalMap);
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tLDAPInput_2_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/LDAP_TOS/ldap.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"whenCreated","whenChanged","userPrincipalName","name","mail","employeeID","displayName","sAMAccountName","distinguishedName",});        
...
String baseDN_tLDAPInput_1 = "";
	...
	final String decryptedPassword_tLDAPInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SL0VCglILXE+od5vUthB/1xj8UfBOBS3g2ZPEaffYnztpvlLdHOjyhE=");
...
///////////////////////		
	    		...
	    		if(row1.whenCreated != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(row1.whenCreated)			
					          ;	
	    		...
	    		if(row1.whenChanged != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(row1.whenChanged)			
					          ;	
	    		...
	    		if(row1.userPrincipalName != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row1.userPrincipalName)			
					          ;	
	    		...
	    		if(row1.employeeID != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(row1.employeeID)			
					          ;	
	    		...
	    		if(row1.displayName != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(row1.displayName)			
					          ;	
	    		...
	    		if(row1.sAMAccountName != null) { //              
                 row_tLogRow_1[7]=    						    
				                String.valueOf(row1.sAMAccountName)			
					          ;	
	    		...
	    		if(row1.distinguishedName != null) { //              
                 row_tLogRow_1[8]=    						    
				                String.valueOf(row1.distinguishedName)			
					          ;	
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[9];
                            ...
                            rowtFileOutputDelimited_1[2]=row2.userPrincipalName == null ? null : row2.userPrincipalName;
                            ...
                            rowtFileOutputDelimited_1[8]=row2.distinguishedName == null ? null : row2.distinguishedName;
...
public void tLDAPInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tLDAPInput_2_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/LDAP_TOS/ldap.xlsx";
    ...
    xlsxTool_tFileOutputExcel_1.setTruncateExceedingCharacters(false);
		...
		xlsxTool_tFileOutputExcel_1.addCellValue("whenCreated");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("whenChanged");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("userPrincipalName");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("name");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("mail");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("employeeID");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("displayName");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("sAMAccountName");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("distinguishedName");
 ...
 */
	 ...
	 */
		...
		ok_Hash.put("tLDAPInput_2", false);
		start_Hash.put("tLDAPInput_2", System.currentTimeMillis());
		
	
	currentComponent="tLDAPInput_2";

	
		int tos_count_tLDAPInput_2 = 0;
		

 
String baseDN_tLDAPInput_2 = "";
	int tLDAPInput_2_NB_LINE = 0;
	java.util.Hashtable env_tLDAPInput_2 = new java.util.Hashtable();
	env_tLDAPInput_2.put(javax.naming.Context.INITIAL_CONTEXT_FACTORY, "com.sun.jndi.ldap.LdapCtxFactory");
	env_tLDAPInput_2.put(javax.naming.Context.REFERRAL, "ignore");
	env_tLDAPInput_2.put("java.naming.ldap.derefAliases","always");
	env_tLDAPInput_2.put(javax.naming.Context.PROVIDER_URL, "ldap://"+"fortel.local"+":"+389);
   
   	javax.naming.ldap.InitialLdapContext ctx_tLDAPInput_2 = null;
	try{
	...
	final String decryptedPassword_tLDAPInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:GilBT8VW5AKvZiEkpVdBEbzvszdfevxyO05TFwhOWCJ80hv6+kgzy/c=");

		env_tLDAPInput_2.put(javax.naming.Context.SECURITY_AUTHENTICATION, "simple");// "none","simple","strong"
    env_tLDAPInput_2.put(javax.naming.Context.SECURITY_PRINCIPAL, "alejandro.montalvan@fortel.local");
    env_tLDAPInput_2.put(javax.naming.Context.SECURITY_CREDENTIALS, decryptedPassword_tLDAPInput_2);
 ctx_tLDAPInput_2 = new javax.naming.ldap.InitialLdapContext(env_tLDAPInput_2, null);


	
	javax.naming.directory.SearchControls searchCtls_tLDAPInput_2 = new javax.naming.directory.SearchControls();
    searchCtls_tLDAPInput_2.setSearchScope(javax.naming.directory.SearchControls.SUBTREE_SCOPE);
    searchCtls_tLDAPInput_2.setReturningAttributes(new String[]{
		"whenCreated",
		"whenChanged",
		"userPrincipalName",
		"name",
    ...
    searchCtls_tLDAPInput_2.setTimeLimit(10000*1000);
    searchCtls_tLDAPInput_2.setCountLimit(10000);
		baseDN_tLDAPInput_2 = "DC=FORTEL,DC=LOCAL";


    // Set the page size and initialize the cookie that we pass back in subsequent pages
    int pageSize_tLDAPInput_2 = 1000;
    byte[] cookie_tLDAPInput_2 = null;
    // Request the paged results control
    javax.naming.ldap.Control[] ctls_tLDAPInput_2 = new javax.naming.ldap.Control[] { new javax.naming.ldap.PagedResultsControl(pageSize_tLDAPInput_2, true) };
    ctx_tLDAPInput_2.setRequestControls(ctls_tLDAPInput_2);
    
do {

    javax.naming.NamingEnumeration answer_tLDAPInput_2 = ctx_tLDAPInput_2.search(baseDN_tLDAPInput_2, "(&(objectClass=*)(employeeId=*))", searchCtls_tLDAPInput_2);
	
    while (answer_tLDAPInput_2 .hasMoreElements()) {//a
    		row3 = null;			
    	tLDAPInput_2_NB_LINE++;
    	javax.naming.directory.Attributes attrs_tLDAPInput_2 = null;
		row3 = new row3Struct(); 
	try{

            javax.naming.directory.SearchResult sr_tLDAPInput_2  = (javax.naming.directory.SearchResult) answer_tLDAPInput_2.next();
    		globalMap.put("tLDAPInput_2_RESULT_NAME",sr_tLDAPInput_2.getName());
            attrs_tLDAPInput_2 = sr_tLDAPInput_2.getAttributes();
     		// for output          
        if (attrs_tLDAPInput_2 != null) {//b
								javax.naming.directory.Attribute attr_whenCreated_tLDAPInput_2 = attrs_tLDAPInput_2.get("whenCreated");
								if(attr_whenCreated_tLDAPInput_2 != null){
    									StringBuilder attrStr_tLDAPInput_2 = new StringBuilder();
						    			for (javax.naming.NamingEnumeration e_tLDAPInput_2 = attr_whenCreated_tLDAPInput_2.getAll(); e_tLDAPInput_2.hasMore();){
					    				if(attrStr_tLDAPInput_2.length()>0){
    										attrStr_tLDAPInput_2.append(";");
					    				}
    									attrStr_tLDAPInput_2.append(e_tLDAPInput_2.next().toString());
					    			}
					    			row3.whenCreated = attrStr_tLDAPInput_2.toString();			
							} else {
								row3.whenCreated = null;
							}
								javax.naming.directory.Attribute attr_whenChanged_tLDAPInput_2 = attrs_tLDAPInput_2.get("whenChanged");
								if(attr_whenChanged_tLDAPInput_2 != null){
    									StringBuilder attrStr_tLDAPInput_2 = new StringBuilder();
						    			for (javax.naming.NamingEnumeration e_tLDAPInput_2 = attr_whenChanged_tLDAPInput_2.getAll(); e_tLDAPInput_2.hasMore();){
					    				if(attrStr_tLDAPInput_2.length()>0){
    										attrStr_tLDAPInput_2.append(";");
					    				}
    									attrStr_tLDAPInput_2.append(e_tLDAPInput_2.next().toString());
					    			}
					    			row3.whenChanged = attrStr_tLDAPInput_2.toString();			
							} else {
								row3.whenChanged = null;
							}
								javax.naming.directory.Attribute attr_userPrincipalName_tLDAPInput_2 = attrs_tLDAPInput_2.get("userPrincipalName");
								if(attr_userPrincipalName_tLDAPInput_2 != null){
    									StringBuilder attrStr_tLDAPInput_2 = new StringBuilder();
						    			for (javax.naming.NamingEnumeration e_tLDAPInput_2 = attr_userPrincipalName_tLDAPInput_2.getAll(); e_tLDAPInput_2.hasMore();){
					    				if(attrStr_tLDAPInput_2.length()>0){
    										attrStr_tLDAPInput_2.append(";");
					    				}
    									attrStr_tLDAPInput_2.append(e_tLDAPInput_2.next().toString());
					    			}
					    			row3.userPrincipalName = attrStr_tLDAPInput_2.toString();			
							} else {
								row3.userPrincipalName = null;
							}
								javax.naming.directory.Attribute attr_name_tLDAPInput_2 = attrs_tLDAPInput_2.get("name");
								if(attr_name_tLDAPInput_2 != null){
    									StringBuilder attrStr_tLDAPInput_2 = new StringBuilder();
						    			for (javax.naming.NamingEnumeration e_tLDAPInput_2 = attr_name_tLDAPInput_2.getAll(); e_tLDAPInput_2.hasMore();){
					    				if(attrStr_tLDAPInput_2.length()>0){
    										attrStr_tLDAPInput_2.append(";");
					    				}
    									attrStr_tLDAPInput_2.append(e_tLDAPInput_2.next().toString());
					    			}
					    			row3.name = attrStr_tLDAPInput_2.toString();			
							} else {
								row3.name = null;
							}
								javax.naming.directory.Attribute attr_mail_tLDAPInput_2 = attrs_tLDAPInput_2.get("mail");
								if(attr_mail_tLDAPInput_2 != null){
    									StringBuilder attrStr_tLDAPInput_2 = new StringBuilder();
						    			for (javax.naming.NamingEnumeration e_tLDAPInput_2 = attr_mail_tLDAPInput_2.getAll(); e_tLDAPInput_2.hasMore();){
					    				if(attrStr_tLDAPInput_2.length()>0){
    										attrStr_tLDAPInput_2.append(";");
					    				}
    									attrStr_tLDAPInput_2.append(e_tLDAPInput_2.next().toString());
					    			}
					    			row3.mail = attrStr_tLDAPInput_2.toString();			
							} else {
								row3.mail = null;
							}
								javax.naming.directory.Attribute attr_employeeID_tLDAPInput_2 = attrs_tLDAPInput_2.get("employeeID");
								if(attr_employeeID_tLDAPInput_2 != null){
    									StringBuilder attrStr_tLDAPInput_2 = new StringBuilder();
						    			for (javax.naming.NamingEnumeration e_tLDAPInput_2 = attr_employeeID_tLDAPInput_2.getAll(); e_tLDAPInput_2.hasMore();){
					    				if(attrStr_tLDAPInput_2.length()>0){
    										attrStr_tLDAPInput_2.append(";");
					    				}
    									attrStr_tLDAPInput_2.append(e_tLDAPInput_2.next().toString());
					    			}
					    			row3.employeeID = attrStr_tLDAPInput_2.toString();			
							} else {
								row3.employeeID = null;
							}
								javax.naming.directory.Attribute attr_displayName_tLDAPInput_2 = attrs_tLDAPInput_2.get("displayName");
								if(attr_displayName_tLDAPInput_2 != null){
    									StringBuilder attrStr_tLDAPInput_2 = new StringBuilder();
						    			for (javax.naming.NamingEnumeration e_tLDAPInput_2 = attr_displayName_tLDAPInput_2.getAll(); e_tLDAPInput_2.hasMore();){
					    				if(attrStr_tLDAPInput_2.length()>0){
    										attrStr_tLDAPInput_2.append(";");
					    				}
    									attrStr_tLDAPInput_2.append(e_tLDAPInput_2.next().toString());
					    			}
					    			row3.displayName = attrStr_tLDAPInput_2.toString();			
							} else {
								row3.displayName = null;
							}
								javax.naming.directory.Attribute attr_sAMAccountName_tLDAPInput_2 = attrs_tLDAPInput_2.get("sAMAccountName");
								if(attr_sAMAccountName_tLDAPInput_2 != null){
    									StringBuilder attrStr_tLDAPInput_2 = new StringBuilder();
						    			for (javax.naming.NamingEnumeration e_tLDAPInput_2 = attr_sAMAccountName_tLDAPInput_2.getAll(); e_tLDAPInput_2.hasMore();){
					    				if(attrStr_tLDAPInput_2.length()>0){
    										attrStr_tLDAPInput_2.append(";");
					    				}
    									attrStr_tLDAPInput_2.append(e_tLDAPInput_2.next().toString());
					    			}
					    			row3.sAMAccountName = attrStr_tLDAPInput_2.toString();			
							} else {
								row3.sAMAccountName = null;
							}
								javax.naming.directory.Attribute attr_distinguishedName_tLDAPInput_2 = attrs_tLDAPInput_2.get("distinguishedName");
								if(attr_distinguishedName_tLDAPInput_2 != null){
    									StringBuilder attrStr_tLDAPInput_2 = new StringBuilder();
						    			for (javax.naming.NamingEnumeration e_tLDAPInput_2 = attr_distinguishedName_tLDAPInput_2.getAll(); e_tLDAPInput_2.hasMore();){
					    				if(attrStr_tLDAPInput_2.length()>0){
    										attrStr_tLDAPInput_2.append(";");
					    				}
    									attrStr_tLDAPInput_2.append(e_tLDAPInput_2.next().toString());
					    			}
					    			row3.distinguishedName = attrStr_tLDAPInput_2.toString();			
							} else {
								row3.distinguishedName = null;
							}
		}//b
	} catch (java.lang.Exception e) {
globalMap.put("tLDAPInput_2_ERROR_MESSAGE",e.getMessage());
...
/**
 * [tLDAPInput_2 begin ] stop
 */
	
	/**
	 * [tLDAPInput_2 main ] start
	 */
	...
	tos_count_tLDAPInput_2++;

/**
 * [tLDAPInput_2 main ] stop
 */
	
	/**
	 * [tLDAPInput_2 process_data_begin ] start
	 */
...
/**
 * [tLDAPInput_2 process_data_begin ] stop
 */
...
if(row3 != null) { 
	...
	currentComponent="tFileOutputExcel_1";
				...
				xlsxTool_tFileOutputExcel_1.addRow();
	    				...
	    				if(row3.whenCreated != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row3.whenCreated));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row3.whenChanged != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row3.whenChanged));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row3.userPrincipalName != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row3.userPrincipalName));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
	    				...
	    				if(row3.name != null) {
							...
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row3.name));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
	    				...
	    				if(row3.mail != null) {
							...
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row3.mail));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row3.employeeID != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row3.employeeID));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row3.displayName != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row3.displayName));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row3.sAMAccountName != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row3.sAMAccountName));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row3.distinguishedName != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row3.distinguishedName));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
 ...
 */
	...
	/**
	 * [tLDAPInput_2 process_data_end ] start
	 */
...
/**
 * [tLDAPInput_2 process_data_end ] stop
 */
	
	/**
	 * [tLDAPInput_2 end ] start
	 */
    ...
    // examine the response controls
    javax.naming.ldap.Control[] responseControls_tLDAPInput_2 = ctx_tLDAPInput_2.getResponseControls();
    if (responseControls_tLDAPInput_2 != null) {
        for (int i_tLDAPInput_2 = 0; i_tLDAPInput_2 < responseControls_tLDAPInput_2.length; i_tLDAPInput_2++) {
            if (responseControls_tLDAPInput_2[i_tLDAPInput_2] instanceof javax.naming.ldap.PagedResultsResponseControl) {
                javax.naming.ldap.PagedResultsResponseControl prrc_tLDAPInput_2 = (javax.naming.ldap.PagedResultsResponseControl) responseControls_tLDAPInput_2[i_tLDAPInput_2];               
                cookie_tLDAPInput_2 = prrc_tLDAPInput_2.getCookie();
            }
        }
    }
    // pass the cookie back to the server for the next page
    ctx_tLDAPInput_2.setRequestControls(new javax.naming.ldap.Control[] { new javax.naming.ldap.PagedResultsControl(pageSize_tLDAPInput_2, cookie_tLDAPInput_2, javax.naming.ldap.Control.CRITICAL) });

} while ((cookie_tLDAPInput_2 != null) && (cookie_tLDAPInput_2.length != 0));
	}catch (java.lang.Exception e){
globalMap.put("tLDAPInput_2_ERROR_MESSAGE",e.getMessage());
        	throw new java.lang.Exception(e);
	}finally{  
		if(ctx_tLDAPInput_2!=null){
			
			ctx_tLDAPInput_2.close();
			
		}
	}
globalMap.put("tLDAPInput_2_NB_LINE", tLDAPInput_2_NB_LINE);


 

ok_Hash.put("tLDAPInput_2", true);
end_Hash.put("tLDAPInput_2", System.currentTimeMillis());




/**
 * [tLDAPInput_2 end ] stop
 */
 ...
 */
		...
		globalMap.put("tLDAPInput_2_SUBPROCESS_STATE", 1);
	}
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ldap_to_excel.class.getClassLoader().getResourceAsStream("ldap_tos/ldap_to_excel_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ldap_to_excel.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
try {
errorCode = null;tLDAPInput_2Process(globalMap);
if(!"failure".equals(status)) { status = "end"; }
}catch (TalendException e_tLDAPInput_2) {
globalMap.put("tLDAPInput_2_SUBPROCESS_STATE", -1);

e_tLDAPInput_2.printStackTrace();
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ldap_to_excel");
        }
...
/************************************************************************************************
 *     112430 characters generated by Talend Open Studio for Data Integration 
 *     on the 13 de mayo de 2025, 17:44:34 COT
 ************************************************************************************************/
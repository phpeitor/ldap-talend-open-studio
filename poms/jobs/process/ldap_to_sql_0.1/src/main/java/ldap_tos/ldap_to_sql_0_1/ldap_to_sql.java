		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:eJPIujZUrsA2fMGje+cL6CaO7dB8LD7S45r7ni5yAHVMiBne");
				...
				try {
					...
					final String decryptedPassword_tLDAPInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:RvlkX4hBzZSlNQz7FsVaJVoqwGAN1Dlz5G/buamybP93ZYDw499wQ6k=");
 ...
 * 16 de mayo de 2025, 23:34:46 COT
 ************************************************************************************************/